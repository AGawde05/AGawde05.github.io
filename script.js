...
let currentSpace = 1;
let spaceTo = 28; // space numbers start from 0 (go) to 28 (the space before go) */
...
if (mode == "forward"){
if ((part == 1 && index == 11) || (part == 3 && index == 28)){
...
function afterPart1() {
document.getElementById('textParagraph').innerHTML = "<a href='board.html'>Enter World Mission</a>.";
}
